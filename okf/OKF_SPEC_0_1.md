...
description: The Open Knowledge Format 0.1 specification that defines the OKF bundle structure and conventions.
resource: OKF_SPEC_0_1.md
tags: [okf, specification, format]
