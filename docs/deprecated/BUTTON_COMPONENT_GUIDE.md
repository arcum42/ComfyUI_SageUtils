...
The Sage Utils button component documentation has been moved to the OKF bundle.

See `okf/ui/button_guide.md` for the current canonical button component guide and usage examples.

This file now serves as a backward-compatible pointer to the structured OKF documentation.

> Note: The OKF `ui` subbundle is the primary UI documentation source. Legacy docs under `docs/` are retained only as redirects and quick references.
