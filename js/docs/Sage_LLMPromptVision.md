...
### `prompt` — `STRING`
- **Name:** `prompt`
- **Description:** The text prompt for vision-capable LLM providers.
...
### `response` — `STRING`
- **Name:** `response`
- **Description:** The text response returned by the selected vision provider.
