...
# Module-level mapping of system names to prompt texts (ALL_CAPS per project standards)
LUMINA2_SYSTEM_PROMPTS_V2 = {
    ...
    "anime (danbooru)": (
        "You are an assistant designed to generate anime images with the highest degree of "
        "image-text alignment based on danbooru tags."
    ),
    "anime (natural language)": (
        "You are an assistant designed to generate high-quality images with the highest degree of "
        "image-text alignment based on textual prompts."
    ),
    "anime (structured)": (
        "You are an assistant designed to generate high-quality images with the highest degree of "
        "image-text alignment based on structural summary."
    ),
    "negative": (
